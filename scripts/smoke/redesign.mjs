...
for (const token of ['MarketplaceHeader', 'CategoryNavigation', 'landing.popular_title', 'storefront-container']) {
...
if (!catalog.includes('CatalogItemCard')) throw new Error('Catalog page does not use marketplace cards');
if (!catalog.includes('MarketplaceHeader')) throw new Error('Catalog page is missing the marketplace header');
...
for (const utility of ['storefront-container', 'storefront-section', 'storefront-heading', 'product-art-frame']) {
