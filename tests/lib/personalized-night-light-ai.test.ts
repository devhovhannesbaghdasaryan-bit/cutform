...
const boilerplates = [
  {
    image_path: 'catalog/rectangular.jpg',
    manufacturing_process: 'rectangular UV-printed acrylic',
  },
...
describe('buildPersonalizedNightLightOpenAiPayload', () => {
  ...
  it('sizes expectedOptions and optionProcesses to the selection, not a fixed constant', () => {
    ...
    expect(payload.outputContract.optionProcesses).toEqual([
      {
        optionIndex: 1,
        process: 'rectangular UV-printed acrylic',
        publicPath: 'catalog/rectangular.jpg',
      },
