        ...
        <section className="min-w-0 space-y-6">
          ...
          {optionAssets.length ? (
                ...
                {optionAssets.map((option) => (
                  <article key={option.id} className="min-w-0 space-y-4 overflow-hidden rounded-lg border p-3 sm:p-4">
                    ...
                    {option.manufacturing_file_path ? (
                      <AssetPreviewCard title="Manufacturing PNG" path={option.manufacturing_file_path} url={option.manufacturingFileUrl} downloadUrl={option.manufacturingFileDownloadUrl} />
                    ) : (
            ...
            <section className="grid gap-4 sm:grid-cols-2">
              ...
              {item.manufacturing_file_path ? <AssetPreviewCard title="Manufacturing PNG" path={item.manufacturing_file_path} url={parentManufacturingFileUrl} downloadUrl={parentManufacturingFileDownloadUrl} /> : null}
            </section>
          ) : null}
